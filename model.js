...
qnode1.on("ready", function() {
  ...
  setInterval(function() {
    so.write("temperature", 0, "sensorValue", randomFloat(18, 26), function(
      err,
      val
    ) {});
  }, 2800);
  ...
  setInterval(function() {
    so.write("humidity", 0, "sensorValue", randomFloat(40, 70), function(
      err,
      val
    ) {});
  }, 5000);
  setInterval(function() {
    so.write("illuminance", 1, "sensorValue", randomInt(50, 1000), function(
      err,
      val
    ) {});
  }, 8000);
...
qnode1.on("deregistered", function() {
  console.log(">> MQTT d01 node is deregistered to a server");
});
...
qnode1.on("logout", function() {
  console.log(">> MQTT d01 node logs out the network");
});

qnode1.on("reconnect", function() {
  console.log(">> MQTT d01 node reconnect the network");
});

qnode1.on("offline", function() {
  console.log(">> MQTT d01 node offline the network");
});

qnode1.on("message", function(topic, message, packet) {
  console.log(">> MQTT d01 node message from server ", topic);
});
...
qnode2.on("deregistered", function() {
  console.log(">> MQTT d02 node is deregistered to a server");
});
...
qnode2.on("logout", function() {
  console.log(">> MQTT d02 node logs out the network");
});

qnode2.on("reconnect", function() {
  console.log(">> MQTT d02 node reconnect the network");
});

qnode2.on("offline", function() {
  console.log(">> MQTT d02 node offline the network");
});

qnode2.on("message", function(topic, message, packet) {
  console.log(">> MQTT d02 node message from server ", topic);
});
...
qnode3.on("deregistered", function() {
  console.log(">> MQTT d03 node is deregistered to a server");
});
...
qnode3.on("logout", function() {
  console.log(">> MQTT d03 node logs out the network");
});

qnode3.on("reconnect", function() {
  console.log(">> MQTT d03 node reconnect the network");
});

qnode3.on("offline", function() {
  console.log(">> MQTT d03 node offline the network");
});

qnode3.on("message", function(topic, message, packet) {
  console.log(">> MQTT d03 node message from server ", topic);
});
...
qnode4.on("deregistered", function() {
  console.log(">> MQTT d04 node is deregistered to a server");
});
...
qnode4.on("logout", function() {
  console.log(">> MQTT d04 node logs out the network");
});

qnode4.on("reconnect", function() {
  console.log(">> MQTT d04 node reconnect the network");
});

qnode4.on("offline", function() {
  console.log(">> MQTT d04 node offline the network");
});

qnode4.on("message", function(topic, message, packet) {
  console.log(">> MQTT d04 node message from server ", topic);
});
